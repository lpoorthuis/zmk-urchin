...
#define LAYOUT34_NAV \
U_NA                                                     &u_to_U_BASE       U_NA               &kp LS(LG(Z))      &kp LG(V)          &kp LG(C)          &kp LG(X)          &kp LG(Z)     \
...
U_NA                                                     &u_to_U_BASE       U_NA               U_RGB_TOG          U_RGB_EFF          U_RGB_HUI          U_RGB_SAI          U_RGB_BRI          \
...
#define LAYOUT34_NUM \
&kp LBKT           &kp N7             &kp N8             &kp N9             &kp RBKT           U_NA               &u_to_U_BASE                                             U_NA               \
...
#define LAYOUT34_SYM \
&kp LBRC           &kp AMPS           &kp ASTRK          &kp LPAR           &kp RBRC           U_NA               &u_to_U_BASE                                             U_NA               \
...
#define LAYOUT34_FUN \
&kp F12            &kp F7             &kp F8             &kp F9             &kp PSCRN          U_NA               &u_to_U_BASE                                             U_NA               \
